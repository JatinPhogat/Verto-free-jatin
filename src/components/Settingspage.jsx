          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              {activeSection === "shortcuts" && (
                <div className="space-y-1">
                  <SettingRow label="Enable Global Shortcuts" description="Master switch for all keyboard hotkeys">
                          ...
                          <div className="flex items-center gap-1.5">
                            {item.combo.map((k, i) => (
                              <React.Fragment key={k}>
                                <Kbd>{k}</Kbd>
                                {i < item.combo.length - 1 && <span className="text-gray-300 dark:text-slate-500">+</span>}
                              </React.Fragment>
                            ))}
                          </div>
